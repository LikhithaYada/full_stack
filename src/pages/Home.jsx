...
import Meenakshi from '../images/meenakshiTemple.jpeg';
import Ellora from '../images/elloraCaves.jpeg';
import RajaSeat from '../images/rajaSeat.jpeg';
...
const Home = () => {
  ...
  const fetchMonuments = async () => {
    try {
      const res = await axios.get('http://localhost:6001/fetch-monuments');
  ...
  return (
    <div className='HomePage GenPagePadding' >
        <div className="home_banner">
          <h1 className="home_banner_title"> <span></span> ...</h1>
        </div>
